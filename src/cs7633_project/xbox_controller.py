# Copied 6 March 2023 from
# https://github.com/hello-robot/stretch_body/blob/master/body/stretch_body/xbox_controller.py
...
def main():
    xbox_controller = XboxController(print_events=False)
