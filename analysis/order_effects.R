...
plot(hand_ordering_average_times, type = "b", xlab = "Ordering", ylab = "Time (s)", main = "Time to Complete All Tasks", xaxt='n', ylim=c(0,1400))
points(xbox_ordering_average_times, type = "b", col = "red")
points(gui_ordering_average_times, type = "b", col = "green")
axis(1, at = 1:3, labels = c("First Task", "Second Task", "Third Task"))
grid()
legend("topright", legend = c("Xbox", "GUI", "Hand"), col = c("red", "green", "black"), lty = 1, cex = 0.8)
